...
| **CreateOS** | `CREATEOS_SANDBOX_API_KEY`, `CREATEOS_SANDBOX_BASE_URL` | Firecracker microVM sandboxes with pause/resume/fork snapshots |
...
npm install @computesdk/createos-sandbox # CreateOS Firecracker microVM provider
...
- **[@computesdk/createos-sandbox](./packages/createos-sandbox)** - NodeOps Firecracker microVM sandboxes, with pause/resume/fork snapshots and a native-handle escape hatch
