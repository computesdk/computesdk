...
ComputeSDK comes with a universal client that works in browser, Node.js, and edge runtimes. Provides direct API access (and a WebContainer API polyfill) for use when you want direct interaction with the sandbox.
