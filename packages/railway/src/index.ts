/**
 * Railway Provider - Gateway Wrapper
 * 
...
import { defineGatewayProvider, type GatewayConfig } from '@computesdk/provider';

/**
 * Railway provider configuration
 */
export interface RailwayConfig extends GatewayConfig {
...
/**
 * Railway provider - routes through ComputeSDK gateway
 * 
